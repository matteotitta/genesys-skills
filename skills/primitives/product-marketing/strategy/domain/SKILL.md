...
Trademark screening and social-handle checks are **deliberately deferred** until after availability and budget filtering. There's no point clearing a trademark on a name you can't register. See `references/domain-hunt-flow.md` for the full step-by-step.
...
Nine steps, availability-first. Full commands and the anti-bot tool ladders live in `references/domain-hunt-flow.md`; the seed-word brainstorming method and budget buckets live in `references/naming-patterns.md`.
...
## Output — the domain shortlist

The artifact is a ranked shortlist, bucketed by availability, with a screened top pick:
...
- `references/domain-hunt-flow.md` — the full 9-step flow with free-tooling commands and anti-bot tool ladders
- `references/naming-patterns.md` — the seed-word brainstorming method, prefix/suffix grid, and budget buckets
